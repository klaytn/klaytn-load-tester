...
func initTCList() []*boomer.Task {
	var taskSet []*boomer.Task

	taskSet = append(taskSet, &boomer.Task{
...
func main() {
	...
	for _, task := range filteredTask {
		...
		println("=> " + task.Name + " task is inited.")
	}
